  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved car as @car" do
        ...
        post :create, {:car => { "way" => "invalid value" }}, valid_session
        assigns(:car).should be_a_new(Car)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested car" do
        ...
        Car.any_instance.should_receive(:update).with({ "way" => "1" })
        put :update, {:id => car.to_param, :car => { "way" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the car as @car" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Car.any_instance.stub(:save).and_return(false)
        put :update, {:id => car.to_param, :car => { "way" => "invalid value" }}, valid_session
        assigns(:car).should eq(car)
      end
